...
mod tests {
    ...
    fn assemble_rrmovq() {
        ...
        assert_eq!(
            AsmUnit::read_asm(PATH).unwrap().asm,
            &[0x20, 0x00, 0xab, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
        );
    ...
    fn assemble_irmovq_base10() {
        ...
        assert_eq!(
            AsmUnit::read_asm(PATH).unwrap().asm,
            &[0x30, 0xf0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
        );
